...
*Any alteration or transformation of the product, including using a third-party application to modify or adjust motor controller settings, even on a single occasion, will result in the complete voidance of the product warranty, not only for issues caused by the third-party app but for any other issues that may arise during the warranty period.*<br>
...
**Untamed is partially working with the latest C4/C4ST "Adaptive Power" firmware. Field weakening seems to give issues. Removing the speed limit does work.**<br><br>
...
An user thinks it only happens once during the upgrade and the settings can be altered afterwards.<br>Please let me know if this is correct.
...
Latest release: [Untamed phone app](https://github.com/Imaginous/Cowboy_Untamed/releases/latest)<br>
Latest release: [Untamed watch app](https://github.com/Imaginous/Cowboy_Untamed/releases/download/V3.61/cowboyuntamed_watch_v1_00.apk) - [*Click here for more info*](https://github.com/Imaginous/Cowboy_Untamed/blob/main/WatchApp.md)<br>
...
If you don't have a Cowbow bike yet... use this [refferal link](https://cowboy.mention-me.com/m/ol/bb8vf-michel-van-der-zwet) for a free bike rack and stand on your new bike.<br>
...
With the Cowboy Untamed app you can reset your PCB. This will not reset any settings but only reboot the communications PCB. This might fix connection or communication problems.<br>Connect to your bike with the Cowboy Untamed app. Select *Reset PCB (Fix headlight bug)* from the menu. This will reboot the bike, shown by "running lights" on the main tube LEDs. 
